...
...     return [
...         &amp;lcub;"bounds": &amp;lcub;"min": 1e-6, "max": 1e-4}, "name": "learning_rate", "type": "double"},
...         &amp;lcub;
...
...     return &amp;lcub;
...         "method": "random",
...         "metric": &amp;lcub;"name": "objective", "goal": "minimize"},
...         "parameters": &amp;lcub;
...             "learning_rate": &amp;lcub;"distribution": "uniform", "min": 1e-6, "max": 1e-4},
...             "per_device_train_batch_size": &amp;lcub;"values": [16, 32, 64, 128]},
...         },
...     }
```
