...
dimensions \\(l_&amp;lcub;1} \times d_&amp;lcub;1}\\) and \\(l_&amp;lcub;2} \times d_&amp;lcub;2}\\), such that \\(l_&amp;lcub;1} \times l_&amp;lcub;2} = l\\) and
\\(d_&amp;lcub;1} + d_&amp;lcub;2} = d\\) (with the product for the lengths, this ends up being way smaller). The embedding for time
