...
```
pip install oneccl_bind_pt==&amp;lcub;pytorch_version} -f https://developer.intel.com/ipex-whl-stable-cpu
```
where `&amp;lcub;pytorch_version}` should be your PyTorch version, for instance 1.13.0.
