...
>>> generator("https://huggingface.co/datasets/Narsil/asr_dummy/resolve/main/mlk.flac")
&amp;lcub;'text': 'I HAVE A DREAM BUT ONE DAY THIS NATION WILL RISE UP AND LIVE OUT THE TRUE MEANING OF ITS CREED', 'chunks': [&amp;lcub;'text': 'I', 'timestamp': (1.22, 1.24)}, &amp;lcub;'text': 'HAVE', 'timestamp': (1.42, 1.58)}, &amp;lcub;'text': 'A', 'timestamp': (1.66, 1.68)}, &amp;lcub;'text': 'DREAM', 'timestamp': (1.76, 2.14)}, &amp;lcub;'text': 'BUT', 'timestamp': (3.68, 3.8)}, &amp;lcub;'text': 'ONE', 'timestamp': (3.94, 4.06)}, &amp;lcub;'text': 'DAY', 'timestamp': (4.16, 4.3)}, &amp;lcub;'text': 'THIS', 'timestamp': (6.36, 6.54)}, &amp;lcub;'text': 'NATION', 'timestamp': (6.68, 7.1)}, &amp;lcub;'text': 'WILL', 'timestamp': (7.32, 7.56)}, &amp;lcub;'text': 'RISE', 'timestamp': (7.8, 8.26)}, &amp;lcub;'text': 'UP', 'timestamp': (8.38, 8.48)}, &amp;lcub;'text': 'AND', 'timestamp': (10.08, 10.18)}, &amp;lcub;'text': 'LIVE', 'timestamp': (10.26, 10.48)}, &amp;lcub;'text': 'OUT', 'timestamp': (10.58, 10.7)}, &amp;lcub;'text': 'THE', 'timestamp': (10.82, 10.9)}, &amp;lcub;'text': 'TRUE', 'timestamp': (10.98, 11.18)}, &amp;lcub;'text': 'MEANING', 'timestamp': (11.26, 11.58)}, &amp;lcub;'text': 'OF', 'timestamp': (11.66, 11.7)}, &amp;lcub;'text': 'ITS', 'timestamp': (11.76, 11.88)}, &amp;lcub;'text': 'CREED', 'timestamp': (12.0, 12.38)}]}
```
...
... )
[&amp;lcub;'score': 0.42515, 'answer': 'us-001', 'start': 16, 'end': 16}]
```
...
pipe = pipeline(model="facebook/opt-1.3b", device_map="auto", model_kwargs=&amp;lcub;"load_in_8bit": True})
output = pipe("This is a cool example!", do_sample=True, top_p=0.95)
```
